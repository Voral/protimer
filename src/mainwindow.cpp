    ...
    ui(new Ui::MainWindow)
{
    ...
    foreach(QString name, presetList)
    {
        ...
        cfg->beginGroup(name);
        project = addProject(cfg->value("name",QString("noname")).toString(),
...
void MainWindow::createTrayIcon()
{
    ...
    trayIcon->setIcon(QPixmap(":/res/coelho/player_time.ico"));
...
void MainWindow::addProject()
{
    ...
    {
        addProject(dlgEdit->getName(),0,dlgEdit->getHours(),dlgEdit->getKeySequence());
    }
    delete dlgEdit;
}
Project* MainWindow::addProject(QString name, qint64 total, int hoursePerDay, QString keySequence)
{
    QVBoxLayout *layout =static_cast <QVBoxLayout *>(ui->frame->layout());
    Project *project = new Project(name, total, hoursePerDay,keySequence, this);
